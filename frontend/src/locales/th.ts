...
export const th: TranslationSchema = {
  ...
  /* กล่องยืนยันตัวตนก่อนทำสิ่งที่ย้อนกลับไม่ได้ */
  confirm: {
    password: 'รหัสผ่านของคุณ',
    passwordPlaceholder: 'กรอกรหัสผ่าน',
    wrongPassword: 'รหัสผ่านไม่ถูกต้อง ยังไม่มีการลบข้อมูลใด ๆ',
  },

  wallets: {
    /* ---- การลบกระเป๋า ต้องยืนยันรหัสผ่าน ---- */
    deleteTitle: 'ลบ {{name}} ใช่ไหม',
    deleteWarning: 'การลบ {{name}} เป็นการลบถาวร',
    deleteWarningBody: 'การลบกระเป๋าย้อนกลับไม่ได้ และไม่มีสำเนาเก็บไว้ในเวิร์กบุ๊ก กรอกรหัสผ่านเพื่อยืนยันว่าเป็นคุณ',
    deleteConfirm: 'ลบกระเป๋า',
    deleteEverything: 'ลบกระเป๋าและข้อมูลทั้งหมด',
    deleteCascadeOption: 'ลบรายการ การลงทุน และงบประมาณทั้งหมดที่ผูกกับกระเป๋านี้ด้วย',
    title: 'กระเป๋าเงิน',
    accounts: 'บัญชี',
  ...
  recurring: {
    /* ---- ค่าบริการที่หารกับคนอื่น ---- */
    shareToggle: 'สร้างบิลหารร่วมเมื่อจ่ายค่าบริการนี้',
    shareHint: 'ทุกครั้งที่จ่าย ระบบจะสร้างบิลในหน้าค่าใช้จ่ายร่วม เพื่อติดตามว่าใครคืนเงินแล้วบ้าง บันทึกเป็นรายจ่ายครั้งเดียว ไม่ซ้ำซ้อน',
    splitDetails: 'ใครต้องจ่ายเท่าไร',
    splitEvenly: 'หารเท่ากัน',
    addPerson: 'เพิ่มคน',
    personName: 'ชื่อ',
    removePerson: 'นำ {{name}} ออก',
    splitEmpty: 'ยังไม่ได้เพิ่มใคร ถ้าไม่เพิ่ม ค่าบริการนี้จะเป็นของคุณทั้งหมด',
    splitSummary: 'คนอื่นค้าง {{owed}} · ส่วนของคุณ {{own}}',
    splitOverBy: 'ยอดที่หารเกินค่าบริการอยู่ {{amount}} ลดลงก่อนจึงจะบันทึกได้',
    splitDuplicate: 'มี “{{name}}” ซ้ำในรายการ',

    sharedBillCreated: 'สร้างบิลหารร่วมแล้ว · มีคนค้างคุณ {{owed}}',
    sharedBillFailed: 'จ่ายเรียบร้อย แต่สร้างบิลหารร่วมไม่สำเร็จ: {{reason}}',
  ...
  theme: {
    ...
    nameOcean: 'มหาสมุทร',
    nameForest: 'ป่าสน',
    nameSunset: 'อาทิตย์อัสดง',
    nameCyberpunk: 'ไซเบอร์พังก์',
    nameRosegold: 'โรสโกลด์',
    nameMidnight: 'เที่ยงคืน',
    nameDracula: 'แดรกคิวลา',
    nameNord: 'นอร์ด',
    nameSolarized: 'โซลาไรซ์',
    nameAmethyst: 'อเมทิสต์',
    nameMatcha: 'มัทฉะ',
    nameOatmilk: 'นมข้าวโอ๊ต',
    nameSakura: 'ซากุระ',
    nameLavender: 'ลาเวนเดอร์',
    nameDaylight: 'แสงกลางวัน',
    nameCocoa: 'โกโก้',
    nameMoonlight: 'แสงจันทร์',
    namePine: 'สนเขา',
    nameSlate: 'หินชนวน',
    nameTwilight: 'สนธยา',
    nameCustom: 'ธีมของคุณ',

    blurbLight: 'โทนกระดาษ ค่าเริ่มต้น',
    blurbDark: 'เทากราไฟต์กับน้ำเงินเย็น',
    blurbOcean: 'น้ำลึกกับฟ้าเย็น',
    blurbForest: 'สนกับมอส',
    blurbSunset: 'ยามพลบบนสีพลัมอุ่น',
    blurbCyberpunk: 'ชมพูนีออนบนดำสนิท',
    blurbRosegold: 'ชมพูอ่อนอุ่นกับทองแดง',
    blurbMidnight: 'โทนมืดที่เงียบที่สุดในชุดนี้',
    blurbDracula: 'จานสีคลาสสิกของนักพัฒนา',
    blurbNord: 'ราตรีขั้วโลกกับน้ำแข็ง',
    blurbSolarized: 'โทนสว่างบนกระดาษอุ่น',
    blurbAmethyst: 'ม่วงเข้มที่สุดในชุดนี้',
    blurbMatcha: 'ครีมนวล เขียวเซจ กับเขียวมะกอกเข้ม',
    blurbOatmilk: 'เบจอุ่น น้ำตาลนวล กับสีเอสเปรสโซ',
    blurbSakura: 'กลีบซากุระกับแดงเลือดหมู',
    blurbLavender: 'ม่วงลิลลี่อ่อนกับม่วงพลัมเข้ม',
    blurbDaylight: 'ขาวสะอาด ฟ้าโปร่ง กับน้ำเงินเข้ม',
    blurbCocoa: 'ช็อกโกแลตเข้มกับครีมอุ่น',
    blurbMoonlight: 'น้ำเงินนวล ฟ้าหม่น กับขาวเย็น',
    blurbPine: 'เขียวถ่านกับมิ้นต์อ่อน',
    blurbSlate: 'เทาน้ำเงินด้านกับสีเงิน',
    blurbTwilight: 'ม่วงหม่นกับลิลลี่อ่อน',
    blurbCustom: 'มิดไนท์ทีล — ผืนผ้าใบเปล่า',
  ...
  explorer: {
    ...
    roleX: 'แกน X',
    roleY: 'แกน Y',
    roleOverlay: 'ซ้อนทับ (สี)',
    rolePage: 'แยกหน้าตาม',
    addVariable: 'เพิ่มตัวแปร',
    removeVariable: 'นำ {{name}} ออก',
    maxVarsReached: 'แผนภูมินี้ใช้ได้สูงสุด {{max}} ตัว นำออกหนึ่งตัวก่อนเพิ่มใหม่',
    oneXForChart: 'แผนภูมินี้ใช้ตัวแปร X ได้ตัวเดียว แผนภูมิแท่งและกล่องซ้อนได้หลายระดับ',
    nestHint: 'ซ้อนจากนอกเข้าใน ตามลำดับที่เพิ่ม',
    sharedYHint: 'ทุกตัวใช้แกน Y เดียวกัน และแยกด้วยสี',
    overlayPausedForMetrics: 'หยุดชั่วคราว — เมื่อมีตัวแปร Y หลายตัว สีจะแทนตัวแปร นำออกหนึ่งตัวเพื่อซ้อนทับอีกครั้ง',
    overlayNotForChart: 'แผนภูมิกล่องแยกสีตามตัวแปร Y ไม่ใช่ตามการซ้อนทับ',
    pageHint: 'หนึ่งแผนภูมิต่อหนึ่งค่า ทุกแผนภูมิใช้สเกลเดียวกัน',
    choose: 'เลือกคอลัมน์',
    none: 'ไม่มี',
    ...
    problemTooManyX: 'แผนภูมินี้ใช้ตัวแปร X น้อยกว่านี้ นำออกหนึ่งตัว',
    problemTooManyY: 'ตัวแปร Y มากเกินไปสำหรับแผนภูมินี้ นำออกหนึ่งตัว',
    problemBadOverlay: 'คอลัมน์นี้ใช้ซ้อนทับบนแผนภูมินี้ไม่ได้',
    problemBadPage: 'การแยกหน้าต้องใช้คอลัมน์หมวดหมู่ ใช่/ไม่ใช่ หรือวันที่',
    problemTooManyFacets: 'แยกหน้าได้มากเกินไป กรุณากรองข้อมูล',
    tooManyFacetsDetail: 'การแยกหน้าตาม {{column}} จะได้ {{panels}} แผนภูมิ แสดงเทียบกันได้สูงสุด {{max}} เพิ่มตัวกรอง หรือเลือกคอลัมน์ที่มีค่าน้อยกว่านี้',

    facetGrid: '{{count}} แผนภูมิ',
    facetCaption_one: 'หนึ่งแผนภูมิต่อ {{column}} · {{count}} แผนภูมิ ใช้สเกลเดียวกันทั้งหมด',
    facetCaption_other: 'หนึ่งแผนภูมิต่อ {{column}} · {{count}} แผนภูมิ ใช้สเกลเดียวกันทั้งหมด',
    seriesColumn: 'ชุดข้อมูล',
    ...
    noteFoldedBands_one: 'รวมหมวดหมู่เล็ก {{count}} หมวดบนแกน X ไว้ใน "อื่น ๆ"',
    noteFoldedBands_other: 'รวมหมวดหมู่เล็ก {{count}} หมวดบนแกน X ไว้ใน "อื่น ๆ"',
  ...
  /* ---- กล่องขาเข้าทางการเงิน ---- */
  inbox: {
    title: 'กล่องขาเข้า',
    placeholder: 'ใหม่ยืมเงินค่าข้าว 300…',
    newItem: 'รายการใหม่ในกล่องขาเข้า',
    add: 'เพิ่มเข้ากล่องขาเข้า',
    moreOptions: 'จำนวนเงิน วันที่ และประเภท',
    type: 'ประเภท',
    typeNote: 'บันทึกเฉย ๆ',
    typeToPay: 'เราติดเขา',
    typeToReceive: 'เขาติดเรา',
    amount: 'จำนวนเงิน',
    dueDate: 'ครบกำหนด',

    empty: 'ยังไม่มีรายการค้าง จดเรื่องเงินที่ต้องจำไว้ด้านบนได้เลย',
    allClear: 'เคลียร์หมดแล้ว',
    pendingCount_one: 'ค้างอยู่ {{count}} รายการ',
    pendingCount_other: 'ค้างอยู่ {{count}} รายการ',
    owedSummary: 'เราติดเขา {{amount}}',
    owedToYouSummary: 'เขาติดเรา {{amount}}',
    overdue: 'เลยกำหนด · {{date}}',
    resolveItem: 'ปิดรายการ “{{text}}”',
    deleteItem: 'ลบรายการ “{{text}}”',

    convertTitle: 'บันทึกเป็นรายการเงินเลยไหม',
    convertPayHint: 'ถ้าใช่ จะบันทึกเป็นรายจ่ายตามจำนวนนี้ และเปิดฟอร์มให้เลือกกระเป๋ากับหมวดหมู่',
    convertReceiveHint: 'ถ้าใช่ จะบันทึกเป็นรายรับตามจำนวนนี้ และเปิดฟอร์มให้เลือกกระเป๋ากับหมวดหมู่',
    convertNoHint: 'ถ้าไม่ จะแค่ปิดรายการ ไม่มีการบันทึกลงบัญชี',
    convertYes: 'ใช่ บันทึกเลย',
    convertNo: 'ไม่ แค่ปิดรายการ',
  },

  /* ---- ตัวจัดการหมวดหมู่ ---- */
  categories: {
    title: 'หมวดหมู่',
    subtitle: 'ป้ายกำกับที่ใช้จัดกลุ่มทุกรายการ งบประมาณ และรายงาน',
    add: 'เพิ่มหมวดหมู่',
    newField: 'ชื่อหมวดหมู่ใหม่',
    newPlaceholder: 'ของใช้ในบ้าน',
    renameField: 'เปลี่ยนชื่อ {{name}}',
    rename: 'เปลี่ยนชื่อ {{name}}',
    remove: 'ลบ {{name}}',
    hint_one: '{{count}} หมวดหมู่ การเปลี่ยนชื่อที่นี่ไม่ได้เปลี่ยนรายการที่บันทึกไว้แล้ว',
    hint_other: '{{count}} หมวดหมู่ การเปลี่ยนชื่อที่นี่ไม่ได้เปลี่ยนรายการที่บันทึกไว้แล้ว',
    atLimit: 'ถึงขีดจำกัดที่ {{max}} หมวดหมู่แล้ว',

    errorEmpty: 'ตั้งชื่อหมวดหมู่ก่อน',
    errorDuplicate: 'มีหมวดหมู่นี้อยู่แล้ว',
    errorTooLong: 'ใช้ได้ไม่เกิน {{max}} ตัวอักษร',
    errorTooMany: 'มีหมวดหมู่ได้สูงสุด {{max}} หมวด',
    errorLast: 'เหลือไว้อย่างน้อยหนึ่งหมวดหมู่ เพราะทุกรายการต้องมีที่ลง',
  },

  /* ---- เครื่องมือวิเคราะห์ทางเทคนิค ----
     ชื่อตัวชี้วัดคงรูปแบบสากล (RSI, MACD) ในทั้งสองภาษา */
  ta: {
    indicators: 'ตัวชี้วัด',
    tune: 'ตั้งค่า…',
    needsVolume: 'ผู้ให้บริการนี้ไม่ส่งข้อมูลปริมาณซื้อขาย จึงคำนวณ VWAP ไม่ได้',

    sma: 'เส้นค่าเฉลี่ยเคลื่อนที่',
    ema: 'ค่าเฉลี่ยเคลื่อนที่แบบเอ็กซ์โพเนนเชียล',
    bollinger: 'แถบโบลลิงเจอร์',
    vwap: 'VWAP (แบบเคลื่อนที่)',
    ichimoku: 'เมฆอิชิโมกุ',
    rsi: 'ดัชนีกำลังสัมพัทธ์ (RSI)',
    macd: 'MACD',
    stochastic: 'สโตแคสติก',
    atr: 'ช่วงแกว่งเฉลี่ยจริง (ATR)',
    adx: 'ดัชนีทิศทางเฉลี่ย (ADX)',

    paramPeriod: 'คาบ',
    paramDeviations: 'ส่วนเบี่ยงเบน',
    paramConversion: 'เส้นเปลี่ยนทิศ',
    paramBase: 'เส้นฐาน',
    paramSpanB: 'สแปน B',
    paramFast: 'เร็ว',
    paramSlow: 'ช้า',
    ...
    rateLimited: 'ถึงขีดจำกัดการเรียก (8 ครั้งต่อนาที) รอสักครู่',
    rateLimitedIn: 'ถึงขีดจำกัดการเรียก จะลองใหม่ใน {{seconds}} วินาที',
    waitSeconds: 'รออีก {{seconds}} วินาที',
    tryAgain: 'ลองอีกครั้ง',
  },
